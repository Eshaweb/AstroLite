...
@Component({
  selector: 'app-horoscope-old',
  templateUrl: './horoscopeOld.component.html',
  styleUrls: ['./horoscopeOld.component.scss']
})
export class HoroscopeOldComponent implements OnInit, OnDestroy, AfterViewInit {
  //public date: Date;
